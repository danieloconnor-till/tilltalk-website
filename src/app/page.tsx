        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-10 flex flex-col items-center gap-4">
            ...
            <a
              ...
              className="bg-[#25D366] hover:bg-[#1fb856] text-white font-semibold px-8 py-4 rounded-xl text-lg transition-colors shadow-md flex items-center gap-2"
            >
      ...
      <section id="chat" className="py-16 px-4 bg-gray-50">
        <div className="max-w-lg mx-auto text-center">
          ...
          <p className="mt-3 text-gray-600 max-w-xl mx-auto">
            Scan the QR code or tap the button to message us directly on WhatsApp.
          ...
          <div className="mt-8 flex flex-col items-center gap-6">
            ...
            />
            <p className="text-sm text-gray-500">Scan with your phone camera to open WhatsApp</p>
            <a
              href="https://wa.me/353894633835"
              target="_blank"
              rel="noopener noreferrer"
